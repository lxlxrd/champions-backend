...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        if ($request->has('admin')) {
            // Tentative d’inscription admin depuis une interface publique => rejetée
            return response()->json([
                'message' => 'Inscription admin non autorisée via cette interface.',
            ], 403);
        }

        // === VALIDATION & INSCRIPTION UTILISATEUR (parent + joueur) ===
